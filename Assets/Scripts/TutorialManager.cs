...
public class TutorialManager : MonoBehaviour {
    ...
    "8/3p4/8/4P3/8/8/8/8 b - - 0 1", // en-passant tutorial
    ...
    public string[][] tutorialMoves = {
        ...
        new string[2] {"d7d5", "e5d6"}, // en-passant capture
    ...
    public string[][] tutorialPrompts = {
        new string[2] {
                        ...
                        "Try moving it vertically or horizontally!"
                    },
        new string[2] {
                        "This is a bishop, a piece that is usually weaker than the rook.\n\nIt moves diagonally.\n\nGive it a try!",
                        "Try moving it on different diagonals!"
                    },
        new string[2] {
        ...
        new string[1] {
                        "You can capture an enemy pawn using your own pawn in a special way.\n\nIf the enemy pawn has moved two squares, moving right next to yours, you can pretend the pawn only moved one square and capture it!\n\nThis is called en-passant.\n\nKeep in mind, this can be done only on this very turn, if the pawns remain unmoved in a future position, en-passant wouldn't be possible.\n\nGive it a try!",
                    },
        new string[3] {
                        ...
                        "You control much more space and you can develop your pieces more easily!"
                    },
        new string[3] {
                        ...
                        "The knights are nicely placed on f3 and c3, their best squares!"
                    },
        new string[3] {
                        ...
                        "The bishops are nicely placed on c4 and f4, controlling important diagonals!"
                    },
        new string[2] {
                        "It is important to keep our king safe.\n\nNow that we've developed our kingside pieces, let's castle short (kingside)",
                        "The king is now safely tucked in the corner and we can push our center pawns without fear!"
                    },
        new string[3] {
                        ...
                        "The rooks nicely control the center and the pawns can be pushed in the future!"
                    },
    };
